...
ID3D10EffectTechnique*      g_pTechniqueRender = nullptr;
ID3D10EffectTechnique*      g_pTechniqueRenderLight = nullptr;
...
ID3D10EffectVectorVariable* g_pLightDirVariable = nullptr;
ID3D10EffectVectorVariable* g_pLightColorVariable = nullptr;
ID3D10EffectVectorVariable* g_pOutputColorVariable = nullptr;
D3DXMATRIX                  g_World;
D3DXMATRIX                  g_View;
...
HRESULT InitDevice()
{
    ...
    #endif
    hr = D3DX10CreateEffectFromFile( L"Tutorial06.fx", nullptr, nullptr, "fx_4_0", dwShaderFlags, 0, g_pd3dDevice, nullptr,
